...
python -m sglang.launch_server \
  --model-path /mnt/shared-storage-user/p1-shared/luotianwei/hf_cache/hub/models--CCCCCyx--full_attn_7b_dense_0226_new_data_iter_0098303/snapshots/b59eed4460eec509cae1301d925a5167763d5456/ \
  --tokenizer-path /mnt/shared-storage-user/p1-shared/luotianwei/hf_cache/hub/models--CCCCCyx--full_attn_7b_dense_0226_new_data_iter_0098303/snapshots/b59eed4460eec509cae1301d925a5167763d5456/ \
  --host 0.0.0.0 \
  --port 30001 \
  --dtype bfloat16 \
  # --disable-cuda-graph \
